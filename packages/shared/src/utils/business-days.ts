...
// Canonical source: migrated from frontend/src/lib/date/business-days.ts.
// Diffed against mobile/src/lib/date/business-days.ts during migration —
// the two holiday sets were byte-identical (44/44 dates, no drift), so no
// union was needed here.
