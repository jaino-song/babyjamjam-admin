...
async function fillStepZero(page: Page) {
  ...
  await page.locator('[data-component="mobile_clients-new_screen_root_page_wizard_form-scroll_basic-details-card_birthday-field_birthday-input"]').fill("19950101");
