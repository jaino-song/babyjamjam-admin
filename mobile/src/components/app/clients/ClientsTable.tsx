                    ...
                    <div className="space-y-2">
                        {isLoading ? (
                            ...
                            filteredClients.map((client: Client, idx: number) => (
                                ...
                                >
                                    <div className={cn(
                                        "w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 shadow-md transition-transform duration-300 group-hover:scale-105 group-hover:-rotate-3",
