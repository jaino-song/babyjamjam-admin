...
jest.mock("@/hooks/useClients", () => ({ useClients: jest.fn(), useDeleteClient: () => ({}), clientQueryKeys: {} }));
...
beforeEach(() => {
  jest.clearAllMocks();
  clientsQuery.mockReturnValue({ data: { data: [] }, isLoading: false, isError: false, isFetching: false, refetch: retryClients } as unknown as ReturnType<typeof useClients>);
...
it("retries the failed client query and recovers to a real empty result", () => {
  clientsQuery.mockReturnValue({ data: undefined, isLoading: false, isError: true, isFetching: false, refetch: retryClients } as unknown as ReturnType<typeof useClients>);
...
it("shows both failures without zero counts when both queries fail", () => {
  clientsQuery.mockReturnValue({ data: undefined, isLoading: false, isError: true, refetch: retryClients } as unknown as ReturnType<typeof useClients>);
