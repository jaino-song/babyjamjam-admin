...
import { Input, InputField } from "@/components/app/v3";
...
export default function ForgotPasswordPage() {
    ...
    return (
        <div data-component="auth-forgot-password-main" className="flex h-full items-center justify-center">
            <CardContainer
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit} data-component="auth-forgot-password-form" className="flex flex-col gap-4">
                            <InputField
                                ...
                                message={fieldError}
                                messageTone="error"
                                messageId={fieldError ? "forgot-password-email-error" : undefined}
                                className="gap-2"
                                labelClassName="text-sm"
                                inputClassName={fieldError ? "border-destructive focus:border-destructive" : undefined}
                                inputProps={{
