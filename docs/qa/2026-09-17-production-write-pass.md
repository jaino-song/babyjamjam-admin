...
- Download investigation follow-up: observed actual mobile UI network responses for existing QA document212cb0fc439d47aca49eb0e97886d788. Receipt request returnedHTTP200,image/png,validPNGsignature(base64length359384); rendered returned image and confirmed two receipt copies with QA customer,09/21–09/29 service dates,total732000/support659000/share73000 and09/18 receipt date. PDF request returnedHTTP200,application/pdf,validPDFsignature(base64length1005476); preview rendered actual document. Source uses validated fetch then Blob-anchor click, so prior browser-eventtimeouts do not prove failure. This closes real file-response/content verification only; final local saved-file proof remainsunverified. No provider resend/sign/cancel/write. Temporary network observation disabled afterward.

- Populated feedback end-to-end QA: PC /chat reloaded the existing QA count-only conversation from10:04KST. Clicked its positive-feedback control once at10:19KST; PC /admin showed total1/positive1/negative0 and correct conversation with the assistant response marked feedback target. Mobile /admin/feedback at390px showed the same row; detailNdqHavDg_CWT36YG__hSm rendered author/time/full QA exchange, back/filter/reload retained the persisted row. Negativefilter removed thepositive row. No new AI prompt or business mutation/send. Earlier zero-session/empty-feedback observations predate this populated evidence and are not current blockers. Durable tool invocation receipt remainsunproven.
- PC invalid /admin/feedback UUID showed notfound/deleted guidance and back returned/admin. Populated mobile detail had readable wrap/nohorizontalclipping at390px. New accessibility findings: PC chat input and feedback icon controls lack accessible names; mobile clickable feedback row exposes container/text instead of link/button. Source trace requested; these are not markedfixed.
- Audit clarification: generic customer163/employee133 creation/edit persistence and service-record memo persistence were already proven (:218–221,244,283,419–421); remaining new-customer case is specifically standalone wizard finalsave. Do not use historical initial audit tables as current unresolved CRUD status.

- Feedback accessibility correction integrated at ea61ee5b03a07f53e7023aac9066bc581a160ef3 from Luna/max unit6ca72cc87f0e195479eb09a535818691269f833b (base308b105b7). Desktop legacy chat now exposes named question/send/positive/negative controls. Mobile feedback opts into native links through mutually-exclusive getSlotHref/onSlotClick props; other list callers retain their behavior. Parentfocusedtests: frontend2/2, mobile4/4; worker type/lint/UIgate/frontendbuild passed. Parent mobilebuild passed with the existing frontend public API setting supplied only to that process; no envfilechange. Existing test-page401/buildwarnings remain unrelated.
- Live correction acceptance: PC AX exposes 질문 입력/전송/도움이 됐어요/개선이 필요해요. Mobile Tab from search focused the named feedback link; Return navigated to the correct real QA detail.390px list screenshot retained card layout and nohorizontalclipping; temporaryviewport restored. IndependentFINALreview and exact-head CI pending at this entry; no deployment.

- Independent whole accessibility FINAL review returnedSHIP/HIGH for exactea61ee5b03a07f53e7023aac9066bc581a160ef3, base308b105b7,8files; reviewer independently reran all6focusedtests. No blockingfindings; merge/deploymentexcluded. Remaining RecentActivitiesPanel onSlotClick wrappers have no mounted caller under mobile/src at this revision, so no additional live defect claimed or genericbehaviorchange made.

- Exact accessibility code head ea61ee5b03a07f53e7023aac9066bc581a160ef3 CI completedSUCCESS: FrontendCI35296246298(type/lint/tests/build), MobileCI35296246281(type/lint/tests/build), MobileUnitCI35296246332 andSharedContractsCI35296246316. GitGuardianpassed. Localbrowser acceptance andindependentreview recordedabove; productiondeployment/retest notperformed.

- Standalone PC /clients/new final-save gap closed: created explicit QA customer164 `QA 독립 등록 검수 20260918` with previously approved controlled QA employee contact, address `QA 전용 독립 등록 확인 주소`, optional birthday empty, no employee/date assignment. Before submit, livebackendPID73486 verifiedSCHEDULERS_ENABLED=false; DBfingerprint13a998ed6278 confirmed. Broad global last-four phone candidatecount9 was not treated as exactmatch; source-equivalent branch/global-unlinked ready-contract candidateupperbound was0. Messageautomationchip switchedOFF.
- One-attempt marker `/tmp/bjj-qa-standalone-client-create-20260918.json` protects against duplicate retry. UIPOST/api/clients capturedapplyMessageAutomation=false and noemployeeassignment; response201 navigated/clients?id=164. Reload retained samefields; mobile listed3QA customers and displayed164withsameaddress/emptybirthday/unassignedstate. ReadonlyDB confirmedid164/exactQAbranch/name/address/birthdaynull.
- Post-marker branch-wide counts: message_log0, message_trigger_job0; client164activeemployeeSchedules0. Customer alerttab showed older employee messages because both PC/mobile intentionally match history byclientId OR normalizedphone. These oldrows were notnewsendproof. This pass created no newSMS/contract/schedule. QAcustomer164remains forreview.
- Mobile standalone finalsave remainsseparate: its payload omitsapplyMessageAutomation and backenddefaultsON, unlike desktopoptout. This is documentedbehavior/probableparitygap, not a confirmedproductrule defect. No mobilefinalcreate wasperformed.

- Public service-record continuation (2026-09-18): opened the existing controlled QA employee link on the loopback mobile QA server, without issuing a new token or message. Empty phone verification showed the required-field error; approved QA employee verification returned201 and context200. Saved synthetic QA header fields with PUT/header200; reload retained verified access and the five planned session dates. This is local/dev evidence, not handset or LAN reachability proof.
- First-day draft validation: negative and fractional meal counts each showed a specific error and disabled Next; valid integer restored progression. Baby-record QA values remained a browser-local draft. Stage3 payment confirmation stayed unchecked; no day submission, signature, finalization or new SMS occurred.
- Confirmed data-preservation defect: fresh post-reload public context returned unlocked session1 with existing QA etcService(length36) and notes(length33), while both corresponding editable textareas were empty. Source review confirms unlocked initialization omits persisted session data, and submitting absent fields reaches backend trimNullable(undefined) => null in the day upsert. No destructive submit was used to demonstrate the issue. PLAN review and a bounded Luna/max hydration correction are pending; existing server memos remain untouched by this pass. Public token and raw health/contact payloads are intentionally absent from evidence.
- Follow-up readonly desktop /messages history: unmatched search produced zero results and cleared detail; canceled filter showed the single existing canceled QA record with cancellation reason; failed filter showed the explicit empty-state guidance. No send/retry action. Public record stage3 desktop screenshot was readable; attempted 390px browser override did not apply (DOM remained1496px), so this attempt supplies no responsive acceptance. Override reset.
- Mobile /messages redirected to /messages/new; history tab loaded six existing QA rows (five successful, one canceled). Search/no-match, reset to six rows, successful-message detail and return-to-list passed. No send/retry. Expanded history search textbox has placeholder but no aria-label/aria-labelledby/associated label (DOM and AX confirmed); new accessibility correction remains pending. Earlier audit claims of untested message route are superseded only for these exercised controls, not all date/pagination combinations.
- Mobile history date controls: recent-one-day filter retained the six today rows; adding August selected zero results; reset returned six and close collapsed the panel. No pagination claim (fixture count six).
- Message-history search accessibility fixed at integrated3193685b1 from Luna/max unit31b3af11ba2786694c1ce82cd3e453480da3c092. Three-file bounded change adds SearchBox inputLabel (default검색어) and explicit contextual caller label; placeholder/filter behavior unchanged. Sol FINALSHIP/HIGH; worker and reviewer focused26tests/type/lint/UIgate passed, worker mobilebuild passed with existing public API value supplied process-only, targeted security review clean. Unsupported offline audit is not claimed as a dependency audit. Parent reran26tests successfully and actual reloaded mobile AX now exposes `고객명, 연락처, 템플릿, 내용 검색`. No deployment.
- Service-record candidate d74c4e166/34557140c restored both existing QA memos in actual service-stage inputs after reload/reopen; screenshot shows readable text and payment remains unchecked. Independent FINAL at unit e1a10f951 returnedFIX_REQUIRED for render-time defaultDateRef potentially mixing context snapshots during history restoration. Candidate is not accepted/released; Luna is replacing that ref with coherent captured-context date derivation. No record submit/signature occurred.
- Service-record correction accepted: unit f6e6128c4d44b8c398966eb5e0cb1d7f5782438f (integrated5ecc19c22) removes render-mutated resolver ref and derives date/session values from one captured context. Sol whole FINALSHIP/HIGH, no blockers. Known nonblocking duplication between existing date resolver and pure context resolver should stay aligned. Worker19focusedtests/type/scopedlint(no warnings)/UIgate/finalbuild/security-pattern checks pass. Parent integrated message+record suites45/45pass.
- Final live acceptance at5ecc19c22: reload existing verified QA link, open session1, browser Back to overview and Forward to service stage all retained both original QA memos and unchecked payment. Captured post-fix public-record requests had zero mutation methods (buffer not truncated). No live day submit, signature or finalization; POST preservation/explicit-clear behavior was verified by page-level mocked regression tests only. Production deployment and exact-head remote CI remain separate gates.

- Exact-head remote verification completed for1afb8e6db3b3ce7b886fe651e30ea21217b3b5fd: MobileCI35299818224 SUCCESS (type/lint/UIgate/copygate/unit/build), MobileUnitCI35299818238 SUCCESS, SharedContractsCI35299818236 SUCCESS. Advisory real-backend Playwright job was skipped and is not counted as browser acceptance. No merge/deployment.
- Mobile standalone-create follow-up: entered synthetic QA name/address/birthday and the already-approved controlled contact belonging to existing QA client162. Duplicate check displayed `이미 등록된 연락처예요` and kept Next disabled. No final submit/request/customer/job/message was created. All three approved contacts already belong to QA clients162/163/164, so an additional unregistered controlled contact was requested for this specific remaining final-save case; no existing QA record/contact was erased to bypass the guard.
- Source preflight for mobile final-save: payload omits applyMessageAutomation, backend defaults it true and can persist/fulfill QA greeting intent/jobs even when SCHEDULERS_ENABLED=false. No employee/dates means no employee schedule. Scheduler-disabled is not proof of zero jobs. Before an eventual single submit, verify exact QA branch, sender approval/rules, zero ready contract reconciliation candidates and live scheduler flag; then inspect new client/case/jobs/message counts.

- Mobile standalone final-save prerequisite resolved without a new contact or modifying existing customers: created a second explicitly named dev QA branch `QA 모바일 등록 검수 20260918` / slug `qa-mobile-create-20260918` / id6e565b2b-b3ac-4b1d-a466-34e402fe7ba1, with no owner, contact or memberships. Creation defaulted sender statusnot_requested and active rules/overrides0. Its active QA name was temporarily present in the dev branch chooser; production was not touched. BackendPID73486 SCHEDULERS_ENABLED=false reverified. Phone-filtered ready contract candidate upper bound0 (unfiltered pool202 was not treated as a match).
- Switched mobile owner session through the actual branch chooser, then submitted /clients/new once using the already-approved contact, synthetic name/address/birthday, no employee/dates and pre_booking. In the new branch the same phone correctly passed the uniqueness check. Captured POST/api/clients201 with automation flag omitted, employee/date fields absent; UI returned customer list1 and detail showed all values. Reload retained the customer. ReadonlyDB confirmedclient165/name/birthday1990-01-15/address; no schedules. This supersedes the earlier controlled-contact blocker: no additional user phone is needed.
- Post-create DB had message_log0 and one `system:message_automation_intent` row52c82749-1516-4407-bdfe-37110339d5d3, statusfailed, retry reason, no recipient. This is internal deferred automation metadata, not an SMS delivery reservation; outbound jobs excluding the intent rule=0. The UI correctly gates message pages when sender approval isnot_requested. Failed intents have no supported UI cancel action and were not raw-DB edited.
- Cleanup: restored mobile session to original QA branch48f9eaf2-7ca9-4e64-8148-9adc3f697aa1 through the chooser, then saved the new QA branch as inactive using owner UI. UI and DB agree isActivefalse/sendernot_requested/ownerIdnull/members0/message_log0/outboundJobs0. Client165 and failed recovery intent remain inspectable fixtures; any later reactivation plus sender approval must account for the retained intent. Marker `/tmp/bjj-qa-mobile-create-branch-20260918.json` records single creation and cleanup. No contract, SMS, signature or production mutation in this pass.
- Service-case clarification: readonly query found no service_record_case forclient165. This is expected because lifecycle.ensureForClient returnsnull without a startDate (service-record-lifecycle.service.ts:235-260); invocation by client creation does not imply a case is always created.

- Responsive continuation: direct tab viewport emulation verified actual DOM widths320/390 (earlier browser-wide override had not applied). Customer list at320/390 and customer163 detail at320 had no document horizontal overflow; long list labels truncate, filters scroll, detail actions and all bottom service amounts remained reachable. Public record overview and first-day mother inputs at320/390 wrapped controls/readable warnings and exposed bottom counts/Next without horizontal overflow. No form values, submits or signatures in this pass. These are specific browser viewport checks, not real-device or all-route acceptance.
- New visual defect reproduced in mobile /prices detail: A가1형 cards at320 had left32/right320; at390 left32/right390, so right gutter disappeared. Computed parentdetail-body padding16 each side plus cardmargin16 each side and mediawidth100% caused it. Source singleprice-breakdown JSX caller; bounded CSS correction under PLANreview. No pricing data changed.
- Additional responsive evidence: /prices detail768px beforefix has symmetric32px gutters (mobilewidth100% override does not apply there); target320/390 mismatch remains. Employee list/detail/information/assigned QA client163 and empty past-work tab all readable at320px with no document horizontal overflow. No employee/customer mutation. New a11y finding: mobile shell bell `mobile_shell_header_icons_notification-bell` has empty text and no aria-label/aria-labelledby/title (AX unnamed popup); source trace pending.

- Price-card correction integrated at afbfccbfc8c9e44f3a743fb506b95915889abfcd from Luna/max unit 3f4030c2d5ba9fec7aa5dd29a4906cfab890b678: removes the child horizontal margin because the detail body already owns 16px padding. Sol FINAL SHIP/HIGH, no findings. Worker typecheck, UI gate, build and targeted security checks passed. Live browser measured all three cards with equal 16px left/right gutters at 320, 390 and 768px and no document overflow. The sibling upload sheet remained readable at320px; it was opened and closed without selecting or uploading a file. These checks close the reproduced margin defect, not global price publishing or production acceptance.
- Mobile /stats/errors at320px displayed the explicit connection-needed state and readable retry control. The local server lacks the required Sentry/PostHog connection; actual provider metrics/reconciliation remains unverified. No integration configuration changed.
- Notification trigger accessibility fixed at integrated d2b20d1ec from Luna/max unit b85a1d99cdca1a06d519576f3b02adae55af4d30. Shared Button now has `알림 열기`; normal Bell and BellOff states are covered by focused14/14 passing tests. Worker typecheck/scoped lint/UI gate/build/security scans passed; Sol FINAL SHIP/HIGH independently reran focused tests and lint. Unsupported offline audit is not a completed dependency audit.
- Live acceptance: employees320px and notification390px AX both expose the named popup button; click opens the same empty notification panel and Escape closes it. The320px screenshot is readable and390px document width equals viewport width. This fixture has no unread notifications, so nonzero unread retention is regression-test evidence only. No subscriptions, mark-read operations, test broadcast or configuration mutations were performed. Remote CI and production deployment remain separate gates.
