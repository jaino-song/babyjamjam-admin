...
@Serializable data class Client(val id: String, val name: String, val phone: String? = null, val email: String? = null, val address: String? = null, val memo: String? = null, val status: String = "active", val babyName: String? = null, val babyBirthDate: String? = null, val dueDate: String? = null, val branchId: String? = null, val createdAt: String? = null, val updatedAt: String? = null)
