...
@Serializable data class Contract(val id: String, val clientId: String, val clientName: String? = null, val employeeId: String? = null, val employeeName: String? = null, val status: String = "draft", val startDate: String? = null, val endDate: String? = null, val serviceType: String? = null, val amount: Long? = null, val branchId: String? = null, val createdAt: String? = null, val updatedAt: String? = null)
