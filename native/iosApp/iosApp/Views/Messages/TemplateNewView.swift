        ...
        ScrollView {
            VStack(alignment: .leading, spacing: AppTheme.Spacing.lg) {
                HStack {
                    ...
                    .accessibilityIdentifier("template-new-back")
                ...
                if let errorMessage = viewModel.errorMessage {
                    ...
                    .cornerRadius(AppTheme.Radius.md)
                    .accessibilityIdentifier("template-new-error")
                }
                ...
                VStack(spacing: AppTheme.Spacing.md) {
                    ...
                    AppFormField(
                        label: "카테고리",
                        text: $category,
                        identifier: "template-new-category"
                    )
                }
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: AppTheme.Spacing.sm) {
                ForEach(variableSuggestions.indices, id: \.self) { index in
                    ...
                    .accessibilityIdentifier("template-new-variable-\(index)")
                }
            }
        }
    }
