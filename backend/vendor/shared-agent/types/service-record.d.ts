...
export type ServiceRecordEditConfirmDocumentStatus = "not_required" | "waiting_for_completion" | "capability_unverified" | "pending";
...
export declare const SERVICE_RECORD_REVISION_DOCUMENT_OPERATIONS: readonly ["record_snapshot", "contract_period", "receipt_refresh"];
export type ServiceRecordRevisionDocumentOperation = (typeof SERVICE_RECORD_REVISION_DOCUMENT_OPERATIONS)[number];
/** Public state vocabulary shared by history, retry, and worker consumers. */
export declare const SERVICE_RECORD_REVISION_DOCUMENT_STATUSES: readonly ["not_required", "waiting_for_completion", "waiting_for_signature", "capability_unverified", "manual_review", "pending", "processing", "unknown", "failed", "completed"];
export type ServiceRecordRevisionDocumentStatus = (typeof SERVICE_RECORD_REVISION_DOCUMENT_STATUSES)[number];
/**
