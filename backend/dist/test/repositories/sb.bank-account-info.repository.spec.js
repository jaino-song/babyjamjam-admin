...
describe("SbBankAccountInfoRepository", () => {
    ...
    const prisma = { bankAccountInfo: bankAccountModel };
    const repository = new sb_bank_account_info_repository_1.SbBankAccountInfoRepository(prisma);
    beforeEach(() => {
        jest.clearAllMocks();
    });
    it("returns a bank account info when findByArea finds a match", async () => {
        ...
        expect(result).toBeInstanceOf(bank_account_info_entity_1.BankAccountInfoEntity);
    ...
    it("creates a bank account info using Prisma", async () => {
        const entity = bank_account_info_entity_1.BankAccountInfoEntity.create("Incheon", "IBK", "987-654-3210");
        const createdRow = {
            area: entity.area,
    ...
    it("updates a bank account info using Prisma", async () => {
        const entity = new bank_account_info_entity_1.BankAccountInfoEntity("Daegu", "Hana Bank", "111-222-3333");
        const updatedRow = {
            area: entity.area,
            bankName: "Shinhan",
            accNum: "444-555-6666",
...
//# sourceMappingURL=sb.bank-account-info.repository.spec.js.map