...
describe("SbMessageRepository", () => {
    ...
    const prisma = { message: messageModel };
    const repository = new sb_message_repository_1.SbMessageRepository(prisma);
    beforeEach(() => {
        jest.clearAllMocks();
    });
    it("returns a message when findById finds a match", async () => {
        ...
        expect(result).toBeInstanceOf(message_entity_1.MessageEntity);
    ...
    it("creates a message using Prisma", async () => {
        const entity = message_entity_1.MessageEntity.create("Title", "Text");
        const createdRow = {
            id: 2,
            title: entity.title,
            text: entity.text,
    ...
    it("updates a message using Prisma", async () => {
        ...
        const entity = new message_entity_1.MessageEntity(3, "Updated", "Message updated", createdAt, editedAt);
        const updatedRow = {
            id: 3,
            title: "Updated",
...
//# sourceMappingURL=sb.message.repository.spec.js.map