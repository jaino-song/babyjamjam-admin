...
describe("SbClientRepository", () => {
    ...
    const prisma = { client: clientModel };
    const repository = new sb_client_repository_1.SbClientRepository(prisma);
    const row = {
        id: 1,
        name: "John Doe",
    ...
    it("returns a client when findById finds a match", async () => {
        ...
        expect(result).toBeInstanceOf(client_entity_1.ClientEntity);
    });
    ...
    it("creates a client via Prisma", async () => {
        const entity = client_entity_1.ClientEntity.create({
            name: "Create",
            primaryEmployeeId: 1,
    ...
    it("updates a client via Prisma", async () => {
        const entity = new client_entity_1.ClientEntity(7, "Update", 3, null, "Addr", "010-3333-4444", "C", 6, "60000", "30000", "30000", new Date("2024-03-01T00:00:00.000Z"), new Date("2024-09-01T00:00:00.000Z"), true, false);
...
//# sourceMappingURL=sb.client.repository.spec.js.map