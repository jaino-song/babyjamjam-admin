...
describe("SbUserRepository", () => {
    ...
    const repository = new sb_user_repository_1.SbUserRepository(prisma);
    beforeEach(() => {
        jest.clearAllMocks();
    });
    ...
    it("creates a user using Prisma", async () => {
        const entity = new user_entity_1.UserEntity("", "kakao-3", "user3@example.com", "User Three", "http://example.com/3.png", "manager", new Date("2024-10-25T12:00:00.000Z"));
        const createdRow = {
            id: "user-3",
    ...
    it("updates a user using Prisma", async () => {
        const entity = new user_entity_1.UserEntity("user-4", "kakao-4", "user4@example.com", "User Four", "http://example.com/4.png", "manager", new Date("2024-09-01T00:00:00.000Z"));
        const updatedRow = {
            id: "user-4",
            kakaoId: "kakao-4",
...
//# sourceMappingURL=sb.user.repository.spec.js.map