...
let CreateEmployeeUsecase = class CreateEmployeeUsecase {
    ...
    execute(name, workArea, phone, grade, openToNextWork, registeredDate) {
        const employee = employee_entity_1.EmployeeEntity.create(name, workArea, phone, grade, openToNextWork, registeredDate);
