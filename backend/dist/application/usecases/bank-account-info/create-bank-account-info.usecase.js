...
exports.CreateBankAccountInfoUsecase = void 0;
...
let CreateBankAccountInfoUsecase = class CreateBankAccountInfoUsecase {
    constructor(bankAccountInfoRepository) {
        this.bankAccountInfoRepository = bankAccountInfoRepository;
    }
    execute(area, bankName, accNum) {
        const bankAccountInfo = bank_account_info_entity_1.BankAccountInfoEntity.create(area, bankName, accNum);
        return this.bankAccountInfoRepository.create(bankAccountInfo);
    }
};
exports.CreateBankAccountInfoUsecase = CreateBankAccountInfoUsecase;
exports.CreateBankAccountInfoUsecase = CreateBankAccountInfoUsecase = __decorate([
...
//# sourceMappingURL=create-bank-account-info.usecase.js.map