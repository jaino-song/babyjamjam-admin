import { CreateBankAccountInfoUsecase, FindBankAccountInfoByAreaUsecase, UpdateBankAccountInfoUsecase, DeleteBankAccountInfoUsecase } from "application/usecases/bank-account-info";
...
export declare class BankAccountInfoService {
    ...
    constructor(createBankAccountInfoUsecase: CreateBankAccountInfoUsecase, findBankAccountInfoByAreaUsecase: FindBankAccountInfoByAreaUsecase, updateBankAccountInfoUsecase: UpdateBankAccountInfoUsecase, deleteBankAccountInfoUsecase: DeleteBankAccountInfoUsecase);
    create(params: {
        area: string;
        bankName: string;
        accNum: string;
