...
exports.EformsignService = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const crypto = __importStar(require("crypto"));
let EformsignService = class EformsignService {
    ...
    async refreshAccessToken(executionTime, refreshToken) {
        const signature = this.generateSignature(executionTime);
    ...
    generateDocumentOptions(contractData, accessToken, refreshToken) {
        return {
            company: {
    ...
    async getDocumentsList(accessToken) {
...
exports.EformsignService = EformsignService;
exports.EformsignService = EformsignService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], EformsignService);
//# sourceMappingURL=eformsign.service.js.map