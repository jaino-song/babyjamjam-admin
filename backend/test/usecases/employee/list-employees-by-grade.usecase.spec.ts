    ...
    describe("execute", () => {
        ...
        describe("basic filtering", () => {
            it("should return employees with matching grade", async () => {
                ...
                // Act
                const result = await usecase.execute("1급");
            ...
            it("should return empty array when no matching grade", async () => {
                ...
                // Act
                const result = await usecase.execute("특급");
        ...
        describe("different grade types", () => {
            it.each(["1급", "2급", "3급", "특급"])("should correctly filter grade %s", async (grade) => {
                ...
                // Act
                const result = await usecase.execute(grade);
        ...
        describe("exact matching", () => {
            it("should require exact grade match", async () => {
                ...
                // Act
                const resultA = await usecase.execute("A");
                const resultSmallA = await usecase.execute("a");
