...
import { frontendScreenshotRoutes } from "./route-manifest";
...
const authenticatedRoutes = frontendScreenshotRoutes.filter((route) => route.auth === "authenticated");
const publicRoutes = frontendScreenshotRoutes.filter((route) => route.auth === "public");
