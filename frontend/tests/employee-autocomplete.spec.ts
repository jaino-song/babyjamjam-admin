...
test.describe('EmployeeAutocomplete', () => {
    ...
    test('should show EmployeeAutocomplete in ClientFormDialog', async ({ page }) => {
        ...
        const employeeAutocomplete = page.locator('[data-component="EmployeeAutocomplete"]').first();
    ...
    test('should open dropdown on focus and show "새 제공인력 추가" button', async ({ page }) => {
        ...
        const autocompleteInput = page.locator('[data-component="EmployeeAutocomplete"] input').first();

        // Click to focus - should open dropdown (Korean IME compatibility)
        await autocompleteInput.click();

        // Wait for dropdown to appear
        const dropdown = page.locator('[data-component="EmployeeAutocomplete-Dropdown"]');
        await expect(dropdown).toBeVisible({ timeout: 5000 });

        // The "새 제공인력 추가" button should be visible
        const addNewButton = page.locator('[data-component="EmployeeAutocomplete-AddNewButton"]');
    ...
    test('should filter employees when typing in search', async ({ page }) => {
        ...
        await expect(page.locator('[data-component="EmployeeAutocomplete-Dropdown"]')).toBeVisible();
    ...
    test('should open EmployeeFormDialog with prefilled name when clicking add button', async ({ page }) => {
        ...
        const addNewEmployeeButton = page.locator('[data-component="EmployeeAutocomplete-AddNewButton"]');
...
test.describe('EmployeeAutocomplete in ContractCreationForm', () => {
    ...
    test('should have EmployeeAutocomplete for selecting caretaker', async ({ page }) => {
        ...
        const employeeAutocomplete = page.locator('[data-component="EmployeeAutocomplete"]');
