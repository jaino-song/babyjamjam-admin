...
import { ServiceFeedbackLinkMessageForm } from "../ServiceFeedbackLinkMessageForm";
...
describe("ServiceFeedbackLinkMessageForm", () => {
  ...
  it("uses name autocompletes and auto-fills the selected employee phone", async () => {
    ...
    expect(screen.getByText("{{feedbackUrl}}")).toBeInTheDocument();
  });

  it("keeps manually entered employee and client names with a formatted phone", async () => {
    render(<ServiceFeedbackLinkMessageForm />);
