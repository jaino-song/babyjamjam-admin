...
export function AgentShell() {
    ...
    const { messages, sendMessage, status, error, actionError, taskError, taskSnapshotState, taskAccessState, taskMutationInFlight, taskNeedsReconciliation, createTaskEventId, commandTask, loadTaskSnapshot, retryPendingTaskEvent, stop, regenerate, resetBranch, sessions, selectSession, renameSession, deleteSession, approveAction, rejectAction, submitStructuredForm, submitFeedback } = useAgentChat();
