...
const ALIGO_POLICY_ITEMS = [
  ...
  },
  {
    ...
    text: "알림톡 발송 기능 제공을 위해 필요한 개인정보를 제3자에게 제공하는 데 동의합니다.",
    sourceLabel: "알리고 회원가입",
    sourceHref: "https://smartsms.aligo.in/join.html",
  },
  {
...
export function AlimtalkTenantApplicationSettings() {
  ...
  const handleSubmit = () => {
    ...
    toast({ description: `${tenantName} 알림톡 발송 신청이 접수되었습니다.` });
  };

  return (
    <div
      data-component="alimtalk-settings-tenant-application"
      className="grid min-h-[560px] flex-1 gap-6 lg:grid-cols-[380px_1fr]"
    >
      <ListPanel
        title="설정"
        subtitle="알림톡에 관련된 설정들을 정할 수 있어요"
        headerActions={
      ...
      <DetailPanel
        ...
        title="알림톡 발송 기능 신청"
        subtitle="알림톡 발송 기능 사용을 위해 아래의 약관들을 확인 및 동의해 주세요."
        trailing={
          requestedAt ? (
      ...
      >
        <div data-component="alimtalk-settings-tenant-detail">
          <div data-component="alimtalk-settings-tenant-form" className="space-y-5 pb-2">
            <div
              data-component="alimtalk-settings-tenant-card"
            ...
            <div data-component="alimtalk-settings-tenant-agreements" className="space-y-3">
              {ALIGO_POLICY_ITEMS.map((policy) => {
                ...
                return (
                  <label
                    key={policy.id}
                    htmlFor={`alimtalk-settings-${policy.id}`}
                    className={cn(
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <Checkbox
                        id={`alimtalk-settings-${policy.id}`}
                        checked={checked}
            ...
            <Button
              data-component="alimtalk-settings-tenant-submit"
              type="button"
            ...
            {requestedAt ? (
              <div
                data-component="alimtalk-settings-tenant-success"
