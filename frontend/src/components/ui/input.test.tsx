...
describe("Input Component", () => {
  ...
  it("renders v3 variant correctly", () => {
    ...
    const input = container.querySelector("input");
    expect(input).toHaveClass("h-[calc(38px*var(--v3-ui-scale,1))]");
    expect(input).toHaveClass("rounded-[13px]");
    expect(input).toHaveClass("border-[1.35px]");
    expect(input).toHaveClass("px-[calc(14px*var(--v3-ui-scale,1))]");
    expect(input).toHaveClass("py-[calc(8px*var(--v3-ui-scale,1))]");
    expect(input).toHaveClass("text-[calc(12px*var(--v3-ui-scale,1))]");
